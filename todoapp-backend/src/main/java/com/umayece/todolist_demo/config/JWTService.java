...
//    public JwtBuilder generateToken(String username , String role) {
//        Map<String, Object> claims = new HashMap<>();
//        claims.put("authorities" ,role ); // Yetkileri token'a ekle
//        return Jwts.builder()
//                .setClaims(claims)
//                .setSubject(username);
//        // Diğer ayarlar...
...
//    }
    ...
    public String generateToken(String userName, String role) {
        Map<String, Object> claims = new HashMap<>();
        claims.put("authorities", role); // Rol bilgisini claims'e ekle
        return createToken(claims, userName);
    }
